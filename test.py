...
parser.add_argument('--task',type=str,default='DH',help='its or ots')
parser.add_argument('--test_imgs',type=str,default='../Dense_Haze_NTIRE19/test/hazy',help='Test imgs folder')
